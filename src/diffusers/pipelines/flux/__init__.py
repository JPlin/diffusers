...
try:
    ...
    _import_structure["pipeline_flux_controlnet_inpainting_native"] = ["FluxControlNetInpaintNativePipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_flux_controlnet_inpainting_native import FluxControlNetInpaintNativePipeline
