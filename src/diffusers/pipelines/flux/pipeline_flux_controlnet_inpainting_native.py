...
from ...models.controlnets.controlnet_flux import FluxControlNetModel
...
class FluxControlNetInpaintingNativePipeline(DiffusionPipeline, FluxLoraLoaderMixin, FromSingleFileMixin):
    r"""
    The Flux inpainting pipeline for image-to-image generation.
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                timestep = t.expand(latent_input.shape[0]).to(latent_input.dtype)
